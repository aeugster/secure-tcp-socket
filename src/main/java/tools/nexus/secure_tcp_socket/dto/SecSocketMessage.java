...
//@EqualsAndHashCode
public class SecSocketMessage implements Serializable {

	// Stamp: Fri 23. Apr 2017
	// 02: 28. Jun 2017
	// 03: 21. Aug 2017 - hash code
	// 04: 28. July 2019 - moved to right package
	 ...
	 * Constructor
	 */
	public SecSocketMessage(String cmd) {
		this.command = cmd;
	}

	public static SecSocketMessage getListRequest() {
		return new SecSocketMessage(SecSocketMessageCmd.list);
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SecSocketMessage other = (SecSocketMessage) obj;
